---
title: "Flows – Visual Conversation Builder"
description: "Build, test, and ship AI phone agents using Phonely Flows. A readable, component-driven guide for designers, builders, and engineers."
---
...
<Info>
  This page evolves as the product evolves. Start here, then jump to sections from the left nav as you need depth.
</Info>
...
<Accordion>
  ...
  <AccordionItem title="How to access variables">
...
<Accordion>
  <AccordionItem title="Conversation design">
